...
const GAY_RANGES = [
  ...
  { min: 101, max: 101, message: "MARCIO ADORA DAR O CU! ESSE GORDINHO ADORA DAR A BUNDA! ESSE RECHONCHUDO 🌈", gif: "marcio_gay2.mp4" },
];
...
export default {
  ...
  commands: ["gay2"],
  usage: `${PREFIX}gaymarcio @usuario ou respondendo a mensagem`,
